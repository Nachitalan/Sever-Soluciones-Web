    ...
    <div className="sever-root">
      ...
      <section id="servicios" className="section section--white">
        ...
        <div className="serv-grid serv-grid--three">
          {[
            { icon: I.truck,   title: "Transporte Terrestre",      desc: "Servicio de autotransporte de carga en caja seca, refrigerada y congelada, contenedores y porta contenedores. Cobertura local, foranea y transfronteriza con EUA." },
            { icon: I.globe,   title: "Importacion y Exportacion", desc: "Gestion completa de comercio internacional: documentacion, aranceles e impuestos, cumplimiento de regulaciones y optimizacion de costos y tiempos de envio." },
            { icon: I.customs, title: "Agencia Aduanal",           desc: "Tramites aduanales, clasificacion arancelaria y permisos de comercio exterior. Inspectores acreditados que garantizan la conformidad de tu mercancia." },
          ].map((s, i) => (
            <Reveal key={i} delay={i * 0.1}>
      ...
      <section id="agencia-aduanal" className="section section--light">
        ...
        <div className="serv-grid serv-grid--three">
          {[
            { icon: I.globe,   title: "Importacion y Exportacion",              desc: "Gestionamos todos los procesos de importacion y exportacion, incluyendo documentacion, aranceles e impuestos, asegurando el cumplimiento de regulaciones y optimizando costos y tiempos de envio." },
            { icon: I.customs, title: "Tramites de Aduana y Comercio Exterior", desc: "Gestion integral de tramites aduanales: clasificacion arancelaria, permisos, certificacion de origen, inspeccion de mercancias y calculo y pago de impuestos y derechos aduaneros." },
            { icon: I.shield,  title: "Previos en Origen",                      desc: "Inspecciones antes del embarque para asegurar el cumplimiento normativo, evitando retenciones, multas y retrasos. Contamos con inspectores acreditados que garantizan la integridad de la mercancia." },
          ].map((s, i) => (
            <Reveal key={i} delay={i * 0.1}>
              <div className="serv-card">
                <div className="serv-card__icon">{s.icon}</div>
      ...
      <section id="capacidades" className="section section--white">
        <Reveal>
          <p className="section__label" style={{ textAlign: "center" }}>CAPACIDADES</p>
          <h2 className="section__title" style={{ textAlign: "center" }}>Operacion y Control</h2>
        </Reveal>
        <div className="serv-grid">
          {[
            { icon: I.gps,    title: "Operacion y Control",       desc: "Monitoreo 24/7 y gestion operativa centralizada con tecnologia de rastreo satelital en tiempo real para cada unidad de la flota." },
            { icon: I.truck,  title: "Infraestructura Flexible",  desc: "Flota dedicada y soluciones adaptadas a cada tipo de carga, desde entregas locales hasta transporte transfronterizo con EUA." },
            { icon: I.box,    title: "Cobertura y Logistica",     desc: "Operacion nacional y transfronteriza con entregas multipunto, cubriendo toda la red de distribucion que el cliente necesite." },
            { icon: I.globe,  title: "Comercio Exterior",         desc: "Gestion integral aduanal y liberacion de mercancia con cumplimiento normativo completo en importacion y exportacion." },
            { icon: I.shield, title: "Seguridad Certificada",     desc: "Cumplimiento con estandares internacionales BASC, C-TPAT, OEA y Transporte Limpio en cada operacion logistica." },
          ].map((s, i) => (
